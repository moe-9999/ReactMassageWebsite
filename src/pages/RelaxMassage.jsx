      ...
      >
        <div className="col-span-2 md:col-span-1 flex flex-col">
          <div className="flex items-center gap-6 px-2 pb-6 border-b-[1px] border-cyan-600">
            <Icon
              icon={<FaRegSmile className="text-white opacity-55" size="46" />}
            />
        ...
        <img
          src={massageImage}
          alt="massage"
          className="image-massage col-span-2 md:col-span-1 max-h-[500px] min-w-full object-cover border-8 border-cyan-700"
        />
      </div>
    </>
  );
